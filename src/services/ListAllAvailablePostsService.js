...
exports.ListAllAvailablePostsService = void 0;
var typeorm_1 = require("typeorm");
var SaudeRepositories_1 = require("../repositories/SaudeRepositories");
var class_transformer_1 = require("class-transformer");
var ListAllAvailablePostsService = /** @class */ (function () {
    function ListAllAvailablePostsService() {
    }
    ListAllAvailablePostsService.prototype.execute = function (_a) {
        var start = _a.start, limit = _a.limit;
        return __awaiter(this, void 0, void 0, function () {
            var saudeRepositories, feed;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        feed = _b.sent();
                        return [2 /*return*/, class_transformer_1.classToPlain(feed)];
                }
            });
        });
    };
    return ListAllAvailablePostsService;
}());
exports.ListAllAvailablePostsService = ListAllAvailablePostsService;
