...
exports.ListAllDocumentsByIdService = void 0;
var class_transformer_1 = require("class-transformer");
var typeorm_1 = require("typeorm");
var ConhecimentoRepositories_1 = require("../repositories/ConhecimentoRepositories");
var ListAllDocumentsByIdService = /** @class */ (function () {
    function ListAllDocumentsByIdService() {
    }
    ListAllDocumentsByIdService.prototype.execute = function (_a) {
        var colaborador_id = _a.colaborador_id;
        return __awaiter(this, void 0, void 0, function () {
            var conhecimentoRepositories, documents;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        documents = _b.sent();
                        return [2 /*return*/, class_transformer_1.classToPlain(documents)];
                }
            });
        });
    };
    return ListAllDocumentsByIdService;
}());
exports.ListAllDocumentsByIdService = ListAllDocumentsByIdService;
