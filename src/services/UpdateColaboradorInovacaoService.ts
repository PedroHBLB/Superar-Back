...
class UpdateColaboradorInovacaoService {
  async execute({
    pillar_id,
    status,
    categoria,
    ...
    try {
      if (
        ...
        redisCleanCache("inovacaoPendentes");
        ...
        redisCleanCache(`${pilar.colaborador_id}Inovacao`);
...
export { UpdateColaboradorInovacaoService };
