...
exports.UpdateColaboradorConhecimentoService = void 0;
...
var UpdateColaboradorConhecimentoService = /** @class */ (function () {
    function UpdateColaboradorConhecimentoService() {
    }
    UpdateColaboradorConhecimentoService.prototype.execute = function (_a) {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!(categoria === "article" ||
                            categoria === "book" ||
                            categoria === "lecture")) return [3 /*break*/, 5];
                    ...
                    case 2:
                        updated = _b.sent();
                        pilar = updated.raw[0];
                        redisCleanCache_1.redisCleanCache(pilar.colaborador_id + "Documents");
                        redisCleanCache_1.redisCleanCache(pilar.colaborador_id + "Ranking");
                        redisCleanCache_1.redisCleanCache(pilar.colaborador_id + "Conhecimento");
                    ...
                    case 3:
                        _b.sent();
                        _b.label = 4;
                    case 4: return [2 /*return*/, class_transformer_1.classToPlain(pilar)];
    ...
    return UpdateColaboradorConhecimentoService;
}());
exports.UpdateColaboradorConhecimentoService = UpdateColaboradorConhecimentoService;
