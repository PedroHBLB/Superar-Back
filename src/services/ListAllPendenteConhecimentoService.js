...
exports.ListAllPendenteConhecimentoService = void 0;
var class_transformer_1 = require("class-transformer");
var typeorm_1 = require("typeorm");
var ConhecimentoRepositories_1 = require("../repositories/ConhecimentoRepositories");
var ListAllPendenteConhecimentoService = /** @class */ (function () {
    function ListAllPendenteConhecimentoService() {
    }
    ListAllPendenteConhecimentoService.prototype.execute = function (_a) {
        var start = _a.start, limit = _a.limit;
        return __awaiter(this, void 0, void 0, function () {
            var conhecimentoRepositories, pendentes;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        pendentes = _b.sent();
                        return [2 /*return*/, class_transformer_1.classToPlain(pendentes)];
                }
            });
        });
    };
    return ListAllPendenteConhecimentoService;
}());
exports.ListAllPendenteConhecimentoService = ListAllPendenteConhecimentoService;
