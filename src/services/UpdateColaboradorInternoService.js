...
exports.UpdateColaboradorInternoService = void 0;
...
var UpdateColaboradorInternoService = /** @class */ (function () {
    function UpdateColaboradorInternoService() {
    }
    UpdateColaboradorInternoService.prototype.execute = function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        (0, redisCleanCache_1.redisCleanCache)("saudePendentes");
                        (0, redisCleanCache_1.redisCleanCache)("availablePosts");
                    ...
                    case 1:
                        ...
                        (0, redisCleanCache_1.redisCleanCache)("".concat(pilar.colaborador_id, "Photos"));
                        (0, redisCleanCache_1.redisCleanCache)("".concat(pilar.colaborador_id, "Ranking"));
                        (0, redisCleanCache_1.redisCleanCache)("".concat(pilar.colaborador_id, "Interno"));
                    ...
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3: return [2 /*return*/, (0, class_transformer_1.classToPlain)(pilar)];
                }
            });
        });
    };
    return UpdateColaboradorInternoService;
}());
exports.UpdateColaboradorInternoService = UpdateColaboradorInternoService;
